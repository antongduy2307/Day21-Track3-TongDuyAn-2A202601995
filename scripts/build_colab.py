...
REPO = "https://github.com/antongduy2307/Day21-Track3-TongDuyAn-2A202601995.git"
if not os.path.exists("Day21-Track3-TongDuyAn-2A202601995"):
    subprocess.run(["git", "clone", "-q", REPO], check=True)
os.chdir("Day21-Track3-TongDuyAn-2A202601995")
